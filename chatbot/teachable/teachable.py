...
while True:
    ...
    if len(response_indices):
        ...
        if value_max:
            ...
            print('Smart Robot: I do not know what to say')
    ...
    if my_input == '$':
        print('Smart Robot: Sorry, what is the correct response?')
        new_response = input('Teach me(Enter to exit): ')
        if not new_response:
            break
    ...
    if my_input == '+':
        print('Smart Robot: What else can you tell me about it?')
        new_response = input('Teach me(Enter to exit): ')
        if not new_response:
            break
        df = add_record(df, current_input, input_lemmatized, new_response)
